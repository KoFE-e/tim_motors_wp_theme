...
<head>
    ...
    <title>Купить авто с доставкой из ОАЭ | Tim Motors</title>
...
<body>
    ...
    <div class="menu-mobile">
        <div class="menu-mobile__wrapper">
            ...
            <a href="#team" class="menu-mobile-link">Детейлинг центр</a>
            <div class="menu-mobile__divider"></div>
        ...
        <nav>
            <div class="menu" id="up">
                ...
                <div class="menu__list">
                    ...
                    <div class="menu__list__item">
                        <a href="#advantages" class="menu__list__link">О нас</a>
                    </div>
                    <div class="menu__list__item">
                        <a href="#team" class="menu__list__link">Детейлинг центр</a>
                    </div>
                </div>
