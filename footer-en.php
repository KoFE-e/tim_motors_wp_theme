<footer class="footer" id="contacts">
            ...
            <div class="footer__wrapper">
                <div class="footer__contacts">
                    ...
                    <div class="footer__contacts__tel">
                        <a href="https://wa.me/<?php the_field('contacts_whatsapp',7); ?>" target="_blank"><?php the_field('contacts_whatsapp',7); ?></a>
                    </div>
                    <div class="footer__contacts__mail">
                        <a href="mailto:<?php the_field('social_mail',7); ?>"><?php the_field('social_mail',7); ?></a>
                    </div>
                    <div class="footer__design">
                        <div class="footer__design__name">Website design: Irina Nakonechnaya</div>
                        <a href="mailto:Mimidesign@mail.ru" class="footer__design__link">Mimidesign@mail.ru</a>
                    </div>
                </div>
                <div class="footer__social">
                    ...
                    <div class="footer__social__links">
                        <a href="<?php the_field('social_youtube',7); ?>" target="_blank" class="footer__social__link">
                ...
                <div class="footer__logo">
                    <div class="footer__logo__img">
                        <img src="<?php echo bloginfo('template_url'); ?>/assets/icons/footer/logo_footer.svg" alt="tim-motors">
                    </div>
                </div>
            </div>
        </div>
    ...
    <a href="#up" class="pageup">
        <img src="<?php echo bloginfo('template_url'); ?>/assets/icons/circle-chevron-up-solid.svg" alt="pageup">
    </a>

    <a href="https://wa.me/<?php the_field('contacts_whatsapp',7); ?>" target="_blank" class="phone">
        <img src="<?php echo bloginfo('template_url'); ?>/assets/icons/circle-phone.svg" alt="phone">
    </a>
  ...
  crossorigin="anonymous"></script>
    <script src="<?php echo bloginfo('template_url'); ?>/assets/js/libs/slick.min.js"></script>
    <script src="<?php echo bloginfo('template_url'); ?>/assets/js/libs/jquery.magnific-popup.min.js"></script>
    <script src="<?php echo bloginfo('template_url'); ?>/assets/js/general_scripts.js"></script>
    <script src="<?php echo bloginfo('template_url'); ?>/assets/js/script_cards.js"></script>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $('.news__inner').slick({
                ...
                swipe: false,
                slidesToShow: 1,
                prevArrow: "<button type='button' class='slick-prev'><img src='<?php echo bloginfo('template_url'); ?>/assets/icons/home/slider/left.png'></button>",
                nextArrow: "<button type='button' class='slick-next'><img src='<?php echo bloginfo('template_url'); ?>/assets/icons/home/slider/right.png'></button>",
                responsive: [{
                    breakpoint: 992,
                    settings: {
                        swipe: true,
        ...
        if (page_language == 'ru') {
            searchBtn.addEventListener('click', () => {
                window.location.href = '<?php echo get_permalink(36); ?>' + '?' + searchParams;
            });
        }
        else {
            searchBtn.addEventListener('click', () => {
                window.location.href = '<?php echo get_permalink(40); ?>' + '?' + searchParams;
            });
        }
    </script>
</body>
