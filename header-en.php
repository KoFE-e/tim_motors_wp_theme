...
<head>
    ...
    <title>Buy a car with delivery from the UAE | Tim Motors</title>
...
<body>
    ...
    <div class="menu-mobile">
        <div class="menu-mobile__wrapper">
            <a href="<?php echo get_permalink(40); ?>" class="menu-mobile-link">Car catalog</a>
            <div class="menu-mobile__divider"></div>
            <a href="#team" class="menu-mobile-link">Detailing center</a>
            <div class="menu-mobile__divider"></div>
        ...
        <nav>
            <div class="menu" id="up">
                ...
                <div class="menu__list">
                    ...
                    <div class="menu__list__item">
                        <a href="#advantages" class="menu__list__link">About Us</a>
                    </div>
                    <div class="menu__list__item">
                        <a href="#team" class="menu__list__link">Detailing center</a>
                    </div>
                </div>
