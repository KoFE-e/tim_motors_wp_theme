...
<section class="promo promo_catalog">
        <div class="language">
            <a href="<?php echo get_permalink(40); ?>" class="language__choice">EN</a>
            <a href="<?php echo get_permalink(36); ?>" class="language__choice language__selected_ru">RU</a>
        </div>
        <div class="container">
        ...
        <div class="promo__search">
            ...
            <div class="promo__search__item">
                <div class="promo__search__dropdown">
                    <div class="promo__search__select selected_dropdown">Диапазон цен</div>
                    <div class="dropdown__list dropdown__slider">
                        <div class="filter-slider dropdown__item" id="mobile-cost-range"></div>
                        <div class="catalog__filter__ranges">
                            <div class="catalog__filter-range" id="mobile-cost-range-min">От $0</div>
                            <div class="catalog__filter-range" id="mobile-cost-range-max">До $1 000 000</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="catalog__wrapper">
                ...
                <div class="catalog__filters">
                    <div class="catalog__filter">
                        <div class="catalog__filter-name">ДИАПАЗОН ЦЕН</div>
                        <div class="filter-slider" id="cost-range"></div>
                        <div class="catalog__filter__ranges">
                            <div class="catalog__filter-range" id="cost-range-min">От $0</div>
                            <div class="catalog__filter-range" id="cost-range-max">До $1 000 000</div>
                        </div>
                    </div>
                    <div class="catalog__filter">
                        <div class="catalog__filter-name">ГОД</div>
