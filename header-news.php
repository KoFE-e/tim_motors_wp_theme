...
<head>
    ...
    <title>Новости | Tim Motors</title>
...
<body>
    ...
    <div class="menu-mobile">
        <div class="menu-mobile__wrapper">
            <a href="<?php echo get_home_url(); ?>" class="menu-mobile-link">Главная</a>
            <div class="menu-mobile__divider"></div>
            <a href="<?php echo get_permalink(36); ?>" class="menu-mobile-link">Каталог авто</a>
            <div class="menu-mobile__divider"></div>
            <a href="<?php echo get_home_url(); ?>#team" class="menu-mobile-link">Детейлинг центр</a>
            <div class="menu-mobile__divider"></div>
    ...
    <header>
        <nav>
            <div class="menu" id="up">
                <a href="<?php echo get_home_url(); ?>" class="menu__logo">
                    <img src="<?php echo bloginfo('template_url'); ?>/assets/icons/menu/logo.svg" alt="logo">
                </a>
                <div class="menu__list">
                    <div class="menu__list__item">
                        <a href="<?php echo get_home_url(); ?>" class="menu__list__link">Главная</a>
                    </div>
                    <div class="menu__list__item">
                        <a href="<?php echo get_home_url(); ?>#advantages" class="menu__list__link">О нас</a>
                    </div>
                    <div class="menu__list__item">
                        <a href="<?php echo get_home_url(); ?>#team" class="menu__list__link">Детейлинг центр</a>
                    </div>
                </div>
