...
<body>
    ...
    <div class="menu-mobile">
        <div class="menu-mobile__wrapper">
            ...
            <a href="<?php echo get_permalink(36); ?>" class="menu-mobile-link">Car catalog</a>
            <div class="menu-mobile__divider"></div>
            <a href="<?php echo get_permalink(40); ?>#team" class="menu-mobile-link">Detailing center</a>
            <div class="menu-mobile__divider"></div>
