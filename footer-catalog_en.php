<footer class="footer" id="contacts">
  ...
  crossorigin="anonymous"></script>
    <script src="<?php echo bloginfo('template_url'); ?>/assets/js/libs/nouislider.min.js"></script>
    ...
    <script src="<?php echo bloginfo('template_url'); ?>/assets/js/script_catalog.js"></script>
